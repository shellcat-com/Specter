...
let package = Package(
    ...
    targets: [
        ...
        .target(name: "MetalTerminal", dependencies: ["TextLayout", "TerminalCore"], resources: [.copy("Shaders.metal")]),
        .target(name: "TerminalUI", dependencies: ["TerminalCore", "PTYSession", "MetalTerminal", "TextLayout"]),
        ...
        .testTarget(name: "RenderingTests", dependencies: ["MetalTerminal", "TextLayout", "TerminalCore"]),
    ]
)
