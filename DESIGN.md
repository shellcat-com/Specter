...
The approved twelve-character study replaces the four original vector companions. Wisp is the default; Moth, Kettle, Mimic, Orbit, Moss, Bytebat, Cinder, Jelly, Origami, Imp, and Rover are equally available. The native companion gallery uses static grid thumbnails and one animated selected preview. Quick pickers remain in the strip and Settings. All choices, including Idle/Busy/Celebrate decorative motion, are saved per profile. Legacy Specter/Comet/Sprout/Pixel IDs migrate to Wisp/Cinder/Moss/Rover; Off remains Off.
